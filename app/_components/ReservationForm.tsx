...
import { BookingData, Cabin } from "../_@types/types";
       ...
       className='bg-primary-900 py-10 px-16 text-lg flex gap-5 flex-col'>
        ...
        <div className='flex justify-end items-center gap-6'>
         ...
         {(startDate && endDate)?
          ...
          :
         <button className='bg-accent-500 px-8 py-4 text-primary-800 font-semibold hover:bg-accent-600 transition-all disabled:cursor-not-allowed disabled:bg-gray-500 disabled:text-gray-300' disabled>
            Reserve now
          </button>
        }
        </div>
